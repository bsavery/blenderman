...
if BLENDER_VERSION_MAJOR > 3:
    BLENDER_PYTHON_VERSION = "3.10"
elif BLENDER_VERSION_MAJOR == 3 and BLENDER_VERSION_MINOR >= 1:
    BLENDER_PYTHON_VERSION = "3.10"
elif BLENDER_VERSION_MAJOR == 2 and BLENDER_VERSION_MINOR >= 93 or BLENDER_VERSION_MAJOR == 3:
